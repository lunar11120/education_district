...
<title>List PrimarySchool</title>
...
<body>
	...
	<div class="sec_lst">
		...
		<header id="header1">
			...
			<div class="container">
				<p id="system_topic">ระบบบริการข้อมูลสำนักงานเขตพื้นที่การศึกษา : สถานศึกษาในเขตพื้นที่การศึกษาประถมศึกษา</p>
			</div>
	    </header><br/>
		 ...
		 <div class="container">
			...
			<spring:url value="/school/list_primaryschool" var="listschool"/>
		    <a href="${home }">หน้าแรก</a>   >>    <a href="${listschool }">สถานศึกษาในเขตพื้นที่การศึกษาประถมศึกษา</a> <br /><br />  	     
    	 </div>    
	
		<div class="container">		
			<p class="line1"></p>
			<c:forEach items="${district_pschool }" var="dt">
